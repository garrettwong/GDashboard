/*
 * @class FontAwesomeSelectService
 * @description data service for font awesome select data
 */
export default class FontAwesomeSelectService {
    /* constructor & header files */
    constructor() {

    }
    static getClassName() {
        return 'FontAwesomeSelectService';
    }
    getClassName() {
        return FontAwesomeSelectService.getClassName();
    }

    /* methods */
    getFaIcons() {
        let iconNames = `fa-adjust
        fa-adn
        fa-align-center
        fa-align-justify
        fa-align-left
