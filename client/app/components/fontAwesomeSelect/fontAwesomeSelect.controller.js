class FontAwesomeSelectController {
  constructor() {
    this.name = 'fontAwesomeSelect';

    this.fontAwesomeIcons = this.getIcons();
  }

  getIcons() {
    let iconBlob = this.getUnformattedIconString();

    return iconBlob.split('\n');
  }

  /*
   * @description gets a string blob of all font awesome icon names from:
   *  http://stackoverflow.com/questions/27992992/i-need-list-of-all-class-name-of-font-awesome
   */
  getUnformattedIconString() {
    return `fa-adjust
fa-adn
fa-align-center
fa-align-justify
...
export default FontAwesomeSelectController;
