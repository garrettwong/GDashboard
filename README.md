...
Gulp is used to seed the notion of components.  This is currently being revisted to more closely mirror Angular 2.x component styles.
...
# Walkthrough
## Build System
GDashboard uses Gulp and Webpack together for its build system. Yes, you don't need Gulp if you're using Webpack. This is true if your build system is only responsible for file manipulation. However, ours is not.
...
## Running the App
GDashboard uses Gulp to build and launch the development environment. After you have installed all dependencies, you may run the app. Running `gulp` will bundle the app with `webpack`, launch a development server, and watch all files. The port will be displayed in the terminal.
